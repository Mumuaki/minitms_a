...
class CargoRepositoryImpl(CargoRepository):
    ...
    def upsert(self, cargo_dto: CargoDto, snapshot_time_bucket: datetime) -> CargoDto:
        ...
        stmt = insert(Cargo).values(
            ...
            description=cargo_dto.description,
            offer_url=cargo_dto.offer_url,
        ...
        update_dict = {
            ...
            "offer_url": stmt.excluded.offer_url,
            "loading_date": stmt.excluded.loading_date,
            "unloading_date": stmt.excluded.unloading_date,
